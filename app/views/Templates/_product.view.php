<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['product_submit'])) {
        $cart->addToCart($_POST['user_id'], $item_id, 'Product?item_id=' . $item_id);
    }
...
?>
   ...
   <section id="product" class="py-3">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <img src="<?php echo $item['item_image'] ?? "http://localhost/Projects/Mobistore/Public/assets/products/1.png"?>" alt="product" class="img-fluid">
